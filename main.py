...
from gamebot.battle import NewGlobalBattleMessage, SendPinToOrder, GetReady
...
dp.filters_factory.bind(ponyfilters.MemberFilter, event_handlers=[dp.message_handlers, dp.callback_query_handlers])
...
dp.register_callback_query_handler(GetReady, is_member=True, text="ready")
